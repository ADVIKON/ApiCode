...
namespace EuforyServices.ServiceImplementation
{
    ...
    public class EuforyServices : IEuforyServices
    {
        ...
        public List<ResponcePlayedSong> PlayedSongsStatusStream(List<DataPlayedSong> data)
        {
            ...
            try
            {
                ...
                foreach (var Player in data)
                {
                    ...
                    string lType = "";
                    SqlCommand cmd = new SqlCommand("spSaveTokenPlayedSongs_Status " + Player.TokenId + ", '" + Player.PlayedDateTime + "' , " + Player.TitleId + "," + Player.ArtistId + "," + Player.splPlaylistId + "", conMain);
                    cmd.CommandType = System.Data.CommandType.Text;
        ...
        public List<ResponceUserRights> GetTokenContent(DataTokenId data)
        {
            List<ResponceUserRights> result = new List<ResponceUserRights>();
            SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["Demo"].ConnectionString);
        ...
        public List<ResponcePublish> CheckTokenPublish(DataCustomerTokenId data)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from AMPlayerTokens where tokenid= " + data.Tokenid + " and IsPublishUpdate=1 ", con);
                cmd.CommandType = System.Data.CommandType.Text;
                if (con.State == ConnectionState.Closed) { con.Open(); }
                SqlDataAdapter ad = new SqlDataAdapter(cmd);
                DataSet ds = new DataSet();
        ...
        public List<ResCustomerList> FillCustomer()
        {
        ...
        public ResResponce SaveCustomer(RegCustomer data)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(data.DfClientId) == true)
                {
                    ...
                    cmdIns.Parameters["@ResponsiblePersonName"].Value = data.customerName;
                    ...
                    cmdIns.Parameters["@IsMainDealer"].Value = 1;
                    ...
                    cmdIns.Parameters["@IsSubDealer"].Value = 0;

                    cmdIns.Parameters.Add(new SqlParameter("@MainDealerId", SqlDbType.BigInt));
                    cmdIns.Parameters["@MainDealerId"].Value = 0;
                ...
                else
                {
                    ...
                    cmdU.Parameters["@ResponsiblePersonName"].Value = data.customerName;
                    ...
                    cmdU.Parameters["@IsMainDealer"].Value = 1;
                    ...
                    cmdU.Parameters["@IsSubDealer"].Value = 0;

                    cmdU.Parameters.Add(new SqlParameter("@MainDealerId", SqlDbType.BigInt));
                    cmdU.Parameters["@MainDealerId"].Value = 0;
        ...
        public RegCustomer EditClickCustomer(ReqTokenInfo data)
        {
            ...
            try
            {
                ...
                sQr = sQr + " Stateid,cityId , isnull(IsMainDealer,0) as IsMainDealer,vatnumber , isnull(issubdealer,0) as isSubdealer, isnull(MainDealerId,0) as MainDealerId, isnull(supportEmail,'') as supportEmail,isnull(supportPhoneNo,'') as supportPhoneNo , tbdealerlogin.ExpiryDate, tbdealerlogin.loginid from DFClients inner join tbdealerlogin on tbdealerlogin.dfclientid= DFClients.dfclientid ";
        ...
        public List<ResPlaylistSongList> PlaylistSong(ReqPlaylistSongList data)
        {
            ...
            try
            {
                ...
                if (data.IsBestOffPlaylist == "Yes")
                {
                    ...
                    sQr = sQr + " Titles.TitleYear ,  rtrim(ltrim(Artists.Name)) as ArtistName,'' as Category  ,Titles.AlbumID, Titles.ArtistID, Titles.mediatype, '0' as srno , isnull(tbGenre.genre,'') as genre FROM ((( TitlesInPlaylists  ";
                ...
                {
                    sQr = "SELECT  Titles.TitleID, rtrim(ltrim(Titles.Title)) as Title, Titles.Time,rtrim(ltrim(Albums.Name)) AS AlbumName ,";
                    sQr = sQr + " Titles.TitleYear ,  rtrim(ltrim(Artists.Name)) as ArtistName , isnull(tbGenre.genre,'') as genre, isnull(Titles.tempo,'') as Tempo  , isnull(acategory,'') as Category ,Titles.AlbumID, Titles.ArtistID, Titles.mediatype, tbSpecialPlaylists_Titles.srno FROM   tbSpecialPlaylists_Titles  ";
                    sQr = sQr + " INNER JOIN Titles ON tbSpecialPlaylists_Titles.TitleID = Titles.TitleID   ";
                    sQr = sQr + " INNER JOIN Albums ON Titles.AlbumID = Albums.AlbumID  ";
                    sQr = sQr + " INNER JOIN Artists ON Titles.ArtistID = Artists.ArtistID  ";
                    sQr = sQr + " LEFT OUTER JOIN tbGenre ON Titles.GenreId = tbGenre.GenreId  ";
                    sQr = sQr + " where tbSpecialPlaylists_Titles.splPlaylistId= " + data.playlistid + " order by tbSpecialPlaylists_Titles.srno ";
                }
        ...
        public List<ResSongList> CommanSearch(ReqCommonSearch data)
        {
            ...
            try
            {
                ...
                {
                    sQr = "spSearch_Title_Comman '" + data.searchText + "','" + data.mediaType + "', " + data.IsRf;
                }
                else if (data.searchType == "artist")
                {
                    sQr = "spSearch_Artist_Comman '" + data.searchText + "','" + data.mediaType + "', " + data.IsRf;
                }
                else if (data.searchType == "album")
                {
                    sQr = "spSearch_Album_spl " + data.searchText + " ,'" + data.mediaType + "', " + data.IsRf;
                }
                else if (data.searchType == "Genre")
                {
                    sQr = " select distinct top 300 TitleID, ltrim(Title) as Title,Time, ltrim(ArtistName) as ArtistName, ltrim(AlbumName) as AlbumName , isnull(genre,'') as genre, Tempo ,titleyear,Category,AlbumID, ArtistID, mediatype  from( ";
                    ...
                    sQr = sQr + " INNER JOIN Artists ON Titles.ArtistID = Artists.ArtistID  ";
                    sQr = sQr + " LEFT OUTER JOIN tbGenre ON Titles.GenreId = tbGenre.GenreId  ";
                    sQr = sQr + " where Titles.GenreId= " + data.searchText + " and Titles.mediatype='" + data.mediaType + "' and IsRoyaltyFree= " + data.IsRf + " ";
                ...
                else if (data.searchType == "Category")
                {
                    ...
                    {
                        if ((data.ClientId != "6") && (data.ClientId != "2"))
                        {
                            sQr = sQr + " and dfclientid= " + data.ClientId;
                        }
                ...
                {
                    sQr = "SELECT TOP (300) Titles.TitleID, Titles.Title, Titles.Time, Artists.Name as ArtistName, Albums.Name AS AlbumName, aCategory as Category,Titles.AlbumID, Titles.ArtistID, Titles.mediatype FROM Titles INNER JOIN Albums ON Titles.AlbumID = Albums.AlbumID INNER JOIN Artists ON Titles.ArtistID = Artists.ArtistID where    mediaType='" + data.mediaType + "' and IsRoyaltyFree=" + data.IsRf + " order by TitleID desc";
                }
                SqlCommand cmd = new SqlCommand(sQr, con);
                cmd.CommandType = System.Data.CommandType.Text;
                con.Open();
        ...
        public List<ResTokenInfo> FillTokenInfoAds(ReqTokenInfoAds data)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(data.UserId) == true)
                {
                    ...
                    sQr = sQr + " isnull(tbCity.CityName,'') as CityName, isnull(tbState.StateName,'') as StateName, isnull(CountryCodes.CountryName,'') as CountryName,isnull(AMPlayerTokens.PersonName ,'') as PersonName , AMPlayerTokens.userid, isnull(AMPlayerTokens.IsStore,0) as IsStore, isnull(AMPlayerTokens.IsStream,0) as IsStream, 'false' as [check] FROM  AMPlayerTokens ";
        ...
        public ResResponce CustomerLogin(ReqLg data)
        {
            ...
            try
            {
                ...
                string sQr = "select * from tbuserlogin_web where username= '" + data.email + "' and password= '" + data.password + "'";
                SqlCommand cmd = new SqlCommand(sQr, con);
                cmd.CommandType = System.Data.CommandType.Text;
                SqlDataAdapter ad = new SqlDataAdapter(cmd);
                ...
                if (dsUser.Rows.Count > 0)
                {
                    ...
                    sQr = "select * from tbDealerLogin where dfClientId =" + dsUser.Rows[0]["dfclientid"].ToString();
                    cmd = new SqlCommand(sQr, con);
                    cmd.CommandType = System.Data.CommandType.Text;
                    ad = new SqlDataAdapter(cmd);
                    dsCustomer = new DataTable();
                    ad.Fill(dsCustomer);

                    Result.IsRf = Convert.ToByte(dsCustomer.Rows[0]["IsDam"]).ToString();

                    sQr = "select * from tbUserLogin_web where id= " + Result.UserId + "";
                    cmd = new SqlCommand(sQr, con);
                    cmd.CommandType = System.Data.CommandType.Text;
                    ad = new SqlDataAdapter(cmd);
                    DataTable ds = new DataTable();
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    if (OldTitle != rdr["title"].ToString())
                    {
                        ...
                        td.pDateTime =Convert.ToDateTime(rdr["pDateTime"]);
                        lstTd.Add(td);
                    }
                }
                constr.Close();
        ...
        public ResResponce SettingPlaylist(ReqSettingPlaylistSong data)
        {
            ...
            try
            {
                string strDel = "";
                DataTable dtDetail = new DataTable();
                strDel = "update  tbSpecialPlaylists set isVideoMute =" + Convert.ToByte(data.chkMute) + " where splplaylistid = " + data.playlistid;
                SqlCommand cmd = new SqlCommand(strDel, con);
                cmd.CommandType = System.Data.CommandType.Text;
                con.Open();
                cmd.ExecuteNonQuery();
        ...
        public List<GenreList> GetGenreList(ReqGenreList data)
        {
            ...
            try
            {
                ...
                str = str + " and Titles.mediatype='" + data.mediatype + "' ";
                if (string.IsNullOrEmpty(data.ClientId) == false)
                {
                    if (data.mediatype == "Image")
                    {
                        if ((data.ClientId != "2") && (data.ClientId != "6"))
                        {
                            str = str + " and Titles.dfclientid=" + data.ClientId + " ";
                        }
                    }
                }
                if (data.mediatype != "Image")
        ...
        public ResResponce SetOnlineIndicator(RegSetOnlineIndicator data)
        {
            ...
            try
            {
                con.Open();
                string strDel = "";
                strDel = "update AMPlayerTokens set IsIndicatorActive =" + Convert.ToByte(data.chkIndicator) + " where clientId=  " + data.ClientId;
                SqlCommand cmd = new SqlCommand(strDel, con);
                cmd.CommandType = CommandType.Text;
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        public ResResponce ForceUpdate(ReqFillAdPlaylist data)
        {
            ...
            try
            {
                ...
                if (data.tokenid == "0")
                {
                    strDel = "update AMPlayerTokens set isPublishUpdate =1  where clientId=  " + data.clientId;
                }
                else
                {
                    strDel = "update AMPlayerTokens set isPublishUpdate =1  where tokenid=  " + data.tokenid;
                }
                SqlCommand cmd = new SqlCommand(strDel, con);
                cmd.CommandType = CommandType.Text;
                cmd.ExecuteNonQuery();
        ...
        public ResResponce UploadSheet()
        {
            ...
            try
            {
                ...
                if (dtM.Columns[2].ToString().ToLower() != "code")
                {
                    Result.Responce = "0";
                    Result.message = "Code column is not match with sequence";
                    conSql.Close();
                    return Result;
                }
                if (dtM.Columns[3].ToString().ToLower() != "name")
                {
                    Result.Responce = "0";
                    Result.message = "Name column is not match with sequence";
                    conSql.Close();
                    return Result;
                }
                if (dtM.Columns[4].ToString().ToLower() != "location")
                {
                    Result.Responce = "0";
                ...
                if (dtM.Columns[5].ToString().ToLower() != "isandroidplayer")
                {
                    Result.Responce = "0";
                ...
                {
                    if ((dtM.Rows[i]["TokenId"].ToString() != "") && (dtM.Rows[i]["tokencode"].ToString() != "") && (dtM.Rows[i]["code"].ToString() != "") && (dtM.Rows[i]["name"].ToString() != "") && (dtM.Rows[i]["location"].ToString() != "")&&(dtM.Rows[i]["IsAndroidPlayer"].ToString() != "") && (dtM.Rows[i]["IsAudioPlayer"].ToString() != ""))
                    {
                        string str = "";
                        
                        str = "update AMPlayerTokens set IsStore=1, token='used', code='" + dtM.Rows[i]["code"] + "'";
                        str = str + ", ptype='Copyright', personname = '" + dtM.Rows[i]["Name"] + "' ";
